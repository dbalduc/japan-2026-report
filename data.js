...
/* ══════════════════════════ DAY 5 ══════════════════════════ */
{
  ...
  blocks:[
    ...
    {t:'text', html:'And then the drift at Kuro-jima. Giant trevally and blue-fin trevally out in the blue, fusiliers strung through the water column, and the reef running past underneath.'},
    {t:'photo', src:'d5-04b-open-water.jpg', wide:true, ar:'16/9',
     cap:'On the drift at Kuro-jima, a few minutes before anything happened.'},
    {t:'text', html:'And then a [[manta|reef manta]] came in over the reef ridge with its mouth open, feeding, and flew the length of the group. After 350-odd dives between the two of us, still the best thing either of us has seen underwater.'},
    {t:'photo', src:'d5-05b-manta-reef.jpg', wide:true, ar:'16/9',
     cap:'<b>First sighting.</b> Cephalic fins unrolled and mouth open — that’s feeding posture. It runs the ridge like this for the better part of twenty seconds.'},
    {t:'video', src:'d5-manta-reef.mp4', label:'The approach — GoPro, dive 3'},
    {t:'text', html:'And then it turned and came straight over the top of us.'},
    {t:'photo', src:'d5-06-manta-approach.jpg', wide:true, ar:'16/9',
     cap:'Closing. Wingspan filling the frame.'},
